...
export default function PlantillaEditor({ id, onBack, inquilino, userEmail }) {
            ...
            <div className="bg-white/80 backdrop-blur-md px-8 py-4 border-b border-slate-200 flex items-center justify-between z-10 shrink-0 shadow-sm">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col">
                        <input
                            className="bg-transparent border-none text-[18px] font-black text-slate-800 uppercase tracking-tighter outline-none w-full md:w-[400px] placeholder:text-slate-300 focus:ring-0"
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                            ...
                            <span className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">Diseñador de Formatos Clínicos</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-[210mm] min-h-[297mm] bg-white shadow-[0_25px_100px_rgba(0,0,0,0.1)] rounded-sm p-[25mm] relative border border-slate-100/50 transition-all">
                        ...
                        {fields.length === 0 ? (
                            ...
                            <div className="flex flex-col gap-6">
                                {fields.map((field) => (
                                    <div key={field.id} className="group relative p-6 bg-slate-50/30 hover:bg-slate-50 border border-transparent hover:border-slate-100 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">

                                        {/* Actions Group */}
                                        <div className="absolute -right-2 top-2 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-4 group-hover:translate-x-0 z-10 flex flex-col gap-1">
                                            <button
                                                onClick={() => removeField(field.id)}
                                                className="w-8 h-8 bg-white text-red-400 hover:text-red-600 rounded-lg shadow-lg flex items-center justify-center border border-slate-100 transition-all hover:scale-110"
                                            >
                                                <FiTrash2 size={14} />
                                            </button>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <input
                                                ...
                                                className="w-full text-[14px] font-black text-slate-700 bg-transparent border-none focus:ring-0 p-0 uppercase placeholder:text-slate-300"
                                        ...
                                        <div className="mt-4 ml-4 flex items-center gap-6">
                                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 cursor-pointer group/check">
                                                <input
                                                    ...
                                                    className="w-4 h-4 rounded border-slate-200 text-blue-600 focus:ring-blue-100 transition-all"
                                                />
