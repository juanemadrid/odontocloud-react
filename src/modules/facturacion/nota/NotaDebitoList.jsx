            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        .title { font-size: 24px; font-weight: 900; text-transform: uppercase; color: ${isAnulado ? '#dc2626' : '#f97316'}; }
                ...
                <body>
                    ...
                    <div class="header">
                        <div>
                            <div class="title">Nota de Débito${isAnulado ? ' — ANULADA' : ''}</div>
                    ...
                    <div class="details">
                        ...
                        <div style="text-align: right;">
                            <span style="color: #64748b; font-weight: bold;">SALDO EN CONTRA GENERADO:</span><br>
                            <strong style="font-size: 14px; text-transform: uppercase; color: #dc2626;">
                                SÍ (${fmt(nota.total)})
                            </strong>
                        </div>
                    </div>
                    ...
                    <div class="total-row">
                        Valor Nota Débito: <span style="color: #f97316; margin-left: 10px;">${totalStr}</span>
                    </div>
