      ...
      <div className="flex-1 min-w-0">
        {showForm ? (
          ...
          <>
            ...
            {/* Gestión inventario (Quick adjustments card grid + Almacén select block) */}
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-6 rounded-[28px] border border-slate-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 bg-blue-50 text-blue-600 border border-blue-100 rounded-full px-5 py-2">
                          <FiDatabase size={12} />
                          <span className="text-[10px] font-black uppercase tracking-tight">ALMACÉN: {selectedAlmacen.nombre}</span>
                          <button 
                            onClick={() => {
                              setSelectedAlmacen(null);
                              localStorage.removeItem("selected_almacen_inventario");
                            }}
                            className="text-[9px] font-black text-rose-500 hover:text-rose-700 ml-2 uppercase tracking-wider"
                          >
                            (Cambiar)
                          </button>
                        </div>
