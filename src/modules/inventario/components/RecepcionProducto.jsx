...
import { FiCalendar, FiBox, FiCheckCircle } from "react-icons/fi";
...
export default function RecepcionProducto({ items, onLoadRequired }) {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      toast.success(`Ingreso registrado: +${qty} ${selectedItem.unidad || "unidades"}`);
    ...
    <div className="max-w-xl mx-auto animate-in fade-in duration-500">
      <div className="bg-white p-8 rounded-[28px] border border-slate-100 shadow-sm space-y-6">
        <div className="border-b border-slate-50 pb-3">
          <h3 className="text-sm font-black text-slate-800 uppercase tracking-wider">Registrar recepción de stock</h3>
          <p className="text-[10px] text-slate-400 font-bold uppercase mt-1">Aumentar inventario de un concepto registrado</p>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Fecha de Ingreso *</label>
              <div className="relative">
                <input
                  type="date"
                  required
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              rows="3"
              placeholder="Notas, número de factura o proveedor..."
